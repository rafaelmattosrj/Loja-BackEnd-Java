...
//				.basePackage("br.com.rafaelmattos.lojamattos.resources"))
...
//				"Esta API é utilizada para pratica do Spring Boot do Rafael Mattos", 
//				"Versão 1.0", 
//				"",
...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do Rafael Mattos", 
				"Esta API é utilizada treino do Rafael Mattos", 
				"Versão 1.0", 
				"",
				new Contact("Rafael Mattos", 
				"https://linktr.ee/rafael.mattos", 
